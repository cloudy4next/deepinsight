...
def parse_arguments(argv):
    ...
    parser.add_argument('--input-dir',default='./test/', type=str, help='Directory with unaligned images.')
    parser.add_argument('--output-dir',default='./testing_data_lfw' ,type=str, help='Directory with aligned face thumbnails.')
